...
You can use the neuro job save command to save a job as a custom image: neuro job save \[JOB\] \[IMAGE\]
...
To share your image, run the command: neuro share [OPTIONS](Name) URI USER \[read\|write\|manage\]
