...
Каждый кластер имеет свой собственный набор настроек, сетевое хранилище и репозиторий.&#x20;
...
Оставшуюся квоту также можно увидеть в выводе команды `neuro config show`.
