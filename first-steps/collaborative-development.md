...
Чтобы загрузить данные с помощью Веб-интерфейса, вам для начала потребуется открыть Filebrowser. Для этого, нажмите **ЗАПУСТИТЬ** в виджете **Браузер дискового пространства**:
...
Кроме того, пользователь получит доступ к этому заданию в своем [Веб-интерфейсе](https://app.ml.cloud.mts.ru/) и сможет отслеживать его логи или работать с ним там.
